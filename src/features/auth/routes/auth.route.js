...
authRout.post('/forgot-password',validate(forgotPasswordSchema),forgotPassword)
authRout.post('/reset-password/:token', validate(resetPasswordSchema),resetPassword)
authRout.post('/admin/login',logInForAdmin)
authRout.post('/admin/verify-2fa',validate(verify2FaSchema),verify2FA)
